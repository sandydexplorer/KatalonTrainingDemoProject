...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Password_password'), 'xE4B+CrCNX3YPUiB7hk23XMOEJm8H9gF')
...
WebUI.waitForElementVisible(findTestObject('Page_CURA Healthcare Service/label_Apply for hospital readmission'), 5)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'This is a sample')
